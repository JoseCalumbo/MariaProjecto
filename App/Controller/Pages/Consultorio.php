...
class Consultorio extends Page
{
    ...
    private static function getExameSolicitado($request, &$obPagination)
    {
        ...
        while ($obExameSolicitado = $resultado->fetchObject(ExameSolicitadoDao::class)) {
            ...
            $item .= View::render('consultorio/listarExameSolicitado', [
    ...
    public static function getExamesSelect()
    {
        ...
        while ($obExame = $listarExames->fetchObject(ExameDao::class)) {
            $resultadoExame .= View::render('consultorio/itemConsulta/exames', [
    ...
    {
        $buscar = filter_input(INPUT_GET, 'pesquisar', FILTER_SANITIZE_STRING);
        $content = View::render('consultorio/Consultorio3', [
    ...
    public static function getcadastrarConsulta($request, $id_triagem)
    {
        ...
        $content = View::render('consultorio/formConsulta', [
    ...
    public static function getValidarConsulta($request, $id_consulta)
    {
        ...
        $content = View::render('consultorio/formConfirmaConsulta', [
            ...
            "buttonExamePedente" => "Salvar e aguardar resultados",
    ...
    private static function getConsultaExame($id_consulta)
    {
        ...
        while ($obExameSolicitado2 = $resultadoExame->fetchObject(ExameSolicitadoDao::class)) {
            ...
            $item2 .= View::render('consultorio/itemConsulta/listarExameConsulta', [
        ...
        if ((int)$totalExame == 0) {
            ...
            $tabela .= View::render('consultorio/itemConsulta/tabelaExame', [
                'itemExames' => $item2,
    ...
    private static function getConsultaReceita($id_consulta)
    {
        ...
        while ($obPacientesEspera = $resultado->fetchObject(TriagemDao::class)) {
            $item .= View::render('consultorio/itemConsulta/listarReceitaConsulta', []);
        }
        ...
        if (false) {
            ...
            $tabela .= View::render('consultorio/itemConsulta/tabelaReceita', [
                'iteMedicamento' => $item
            ]);
        } else {
