...
class Utilitario extends Page
{
    ...
    // Método que apresenta a tela da Tesoraria
    public static function telaUtilitario($request)
    {
        $buscar = filter_input(INPUT_GET, 'pesquisar', FILTER_SANITIZE_STRING);
        $content = View::render('utilitario/utilitario', [
            'pesquisar' => $buscar,
