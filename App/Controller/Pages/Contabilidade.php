...
class Contabilidade extends Page
{
    ...
    // Método para apresenatar os registos do Contabilidade cadastrados
    ...
    // Método que apresenta a tela da Contabilidade
    public static function telaContabilidade($request)
    {
        $buscar = filter_input(INPUT_GET, 'pesquisar', FILTER_SANITIZE_STRING);
        $content = View::render('contabilidade/contabilidade', [
            'pesquisar' => $buscar,
        ...
        return parent::getPage('Painel Tesouraria', $content);
    }
