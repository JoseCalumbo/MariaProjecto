...
$obRouter->get('/relatorio/listaUser',[
    ...
    function($request){ return new Response(200,Imprimir\UsuarioPDF::ListaUserPDF($request)); }
]);
...
$obRouter->get('/relatorio/imprimirLista',[
    ...
    function($request){ return new Response(200,Imprimir\UsuarioPDF::imprimirUser($request)); }
]);
...
$obRouter->get('/vendedorFicha/{id}',[
    ...
    function($request,$id){ return new Response(200,Imprimir\VendedorPDF::imprimiFicha($request,$id)); }
]);
...
$obRouter->get('/cartao/{id}',[
    ...
    function($request,$id){ return new Response(200,Imprimir\VendedorPDF::cartaoVendedor($request,$id)); }
]);
...
$obRouter->get('/declaracao/{id}',[
    ...
    function($request,$id){ return new Response(200,Imprimir\VendedorPDF::declaracaoVendedor($request,$id)); }
]);
