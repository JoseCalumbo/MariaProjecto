...
--
-- Host: 127.0.0.1
-- Tempo de geração: 19-Nov-2025 às 22:26
...
CREATE TABLE `tb_consulta` (
  ...
  `retorno_consulta` date NOT NULL,
...
--
-- Estrutura da tabela `tb_consulta_examepedido`
--

CREATE TABLE `tb_consulta_examepedido` (
  `id_exameSolicitado` int(50) NOT NULL,
  `id_consulta` int(50) NOT NULL,
  `id_funcionario` int(50) NOT NULL,
  `id_exame` int(50) NOT NULL,
  `tipo_exame` varchar(255) DEFAULT NULL,
  `exame_nome` varchar(255) DEFAULT NULL,
  `parametros` varchar(255) DEFAULT NULL,
  `emergencia` varchar(50) DEFAULT NULL,
...
CREATE TABLE `tb_consulta_exames` (
  ...
  `resultado_exame` enum('Positivo','Negativo','Normal','Alto','Baixo') NOT NULL,
  `data_exame_solicitacao` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(37, 'Antónia Miguel Samara', '0033ALA', 'Feminino', '', '2016-10-13', '', '', '', 0, '', 'antonia@hotmail.com', 991901881, 0, 'Casa n 22, Rua A Zango 4 ', 'anonimo.png', NULL, 'Aberto', 1, '2025-10-30 12:07:09');
...
--
-- Índices para tabela `tb_consulta_examepedido`
--
ALTER TABLE `tb_consulta_examepedido`
  ADD PRIMARY KEY (`id_exameSolicitado`);
...
--
-- AUTO_INCREMENT de tabela `tb_consulta_examepedido`
--
ALTER TABLE `tb_consulta_examepedido`
  MODIFY `id_exameSolicitado` int(50) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `tb_consulta_exames`
--
ALTER TABLE `tb_consulta_exames`
  MODIFY `id_exame_solicitado` int(50) NOT NULL AUTO_INCREMENT;
