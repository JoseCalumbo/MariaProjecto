...
--
-- Host: 127.0.0.1
-- Tempo de geração: 10-Out-2025 às 13:50
...
--
ALTER TABLE `tb_funcionario_nivel`
  MODIFY `id_funcionario_nivel` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de tabela `tb_nivel`
--
ALTER TABLE `tb_nivel`
  MODIFY `id_nivel` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
